...
def evaluate(timestep, network, epoch, eval_episodes=10):
    ...
    writer.add_scalar("Average Collision Rate per Episode", avg_col, timestep)
    print("..............................................")
    print(
...
class Critic(nn.Module):
    ...
    def forward(self, s, a):
        ...
        q2 = self.layer_6(s2)
        # sa1 = torch.cat([s, a], -1)
        # sa1 = F.relu(self.layer_1(sa1))
        # sa1 = F.relu(self.layer_2(sa1))
        # q1 = self.layer_3(sa1)
        # sa2 = torch.cat([s, a], -1)
        # sa2 = F.relu(self.layer_1(sa2))
        # sa2 = F.relu(self.layer_2(sa2))
        # q2 = self.layer_3(sa2)
        return q1, q2
...
min_reward = 50000.0
max_reward = -50000.0
evaluations_num = 15 # Number of episodes to measure training stability, previously set to 9 
beta_freq = 1 # Delayed update of balance correction factor
